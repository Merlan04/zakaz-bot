...
from handlers.auto_views_handlers import register_auto_views_handlers
from handlers.orders_handlers import register_orders_handlers
...
def register_all_handlers(bot, user_states):
    ...
    register_orders_handlers(bot, user_states)